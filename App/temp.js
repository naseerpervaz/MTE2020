        ...
        return ( 
            ...
            <View style={{flex: 1,flexDirection: 'column',justifyContent: 'center', marginLeft:10}}>
              ...
              <TextInput style={{width: '90%', height: 26,textAlign:'center',   backgroundColor: 'yellow'}}
                        ...
                        />
              <Text style={{textAlign:'center', marginLeft:13,marginTop: 20, width: '90%', height: 26, backgroundColor: 'lightgray'}}> Livestock Feeder Contract Name </Text>
              <TextInput style={{width: '90%', height: 26,textAlign:'center',   backgroundColor: 'yellow'}}
                            onChangeText={(text)=>this.setState({CowTag: text})}
                            value={this.state.CowTag}
                            placeholder = 'Type here for example MTE2021'
                            placeholderTextColor= 'red' 
               ...
               <Text style={{textAlign:'center', marginLeft:13,marginTop: 5, width: '90%', height: 26, backgroundColor: 'lightgray'}}> Contract Expairy Date</Text>
                  ...
                  <Text style={{textAlign:'center', marginLeft:13,marginTop: 20, width: '90%', height: 26, backgroundColor: 'lightgray'}}> Contract Durration</Text>
              <TextInput style={{width: '90%', height: 26,textAlign:'center',   backgroundColor: 'yellow'}}
                            onChangeText={(text)=>this.setState({CowTag: text})}
                            value={this.state.CowTag}
                            placeholder = 'Type here'
                        ...
                        />
                  <Text style={{textAlign:'center', marginLeft:13,marginTop: 20, width: '90%', height: 26, backgroundColor: 'lightgray'}}> Number of Cattles recived unnder this contract</Text>
              <TextInput style={{width: '90%', height: 26,textAlign:'center',   backgroundColor: 'yellow'}}
                            onChangeText={(text)=>this.setState({CowTag: text})}
                            value={this.state.CowTag}
                            placeholder = 'Type here'
                        ...
                        />
                  <Text style={{textAlign:'center', marginLeft:13,marginTop: 20, width: '90%', height: 26, backgroundColor: 'lightgray'}}> Livestock Tag #</Text>
              <TextInput style={{width: '90%', height: 26,textAlign:'center',   backgroundColor: 'yellow'}}
                            onChangeText={(text)=>this.setState({CowTag: text})}
                            value={this.state.CowTag}
                            placeholder = 'Type here'
